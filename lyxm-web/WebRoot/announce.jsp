                        ...
                        <div class="con">
                            ...
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "/lyxm.xtonegame.com/news?type=3&pagenum="+<%=pageid%>+"&count=10",
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='/lyxm.xtonegame.com/announce.jsp?type=3&pagenum="+pagen+"'>上一页&nbsp </a>");
                             }  
                           ...
                           <% 
                        	...
                        	try{
                        		...
                        		String sql = "SELECT COUNT(1) rowCount FROM tbl_cms_contents WHERE catalog='announce'";
                        		...
                        		if(rowCount>pageid*15){
                        			 pagen=pageid+1;
                        			 out.print("&nbsp<a href='/lyxm.xtonegame.com/announce.jsp?type=3&pagenum="+pagen+"&count=15'>下一页&nbsp </a>");
...
<script type="text/javascript">
	   $(document).ready(function(){
		   function showfirst(){
			   $('.nNewsTit #nli_3 a').addClass("active");
			   $('.con #news_1').show();
		   }
