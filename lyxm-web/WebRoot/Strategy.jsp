                        ...
                        <div class="con">
                            ...
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "/lyxm.xtonegame.com/guides?type=2&pagenum="+<%=pageid%>+"&count=10",
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='/lyxm.xtonegame.com/Strategy.jsp?type=0&pagenum="+pagen+"&count=10'>上一页&nbsp </a>");
                             }  
                           ...
                           pagen=pageid+1;
                      	   out.print("&nbsp<a href='/lyxm.xtonegame.com/Strategy.jsp?type=0&pagenum="+pagen+"&count=10'>下一页&nbsp </a>");
