                        ...
                        <div class="con">
                            ...
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "/lyxm.xtonegame.com/events?pagenum="+<%=pageid%>+"&count=10",
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='/lyxm.xtonegame.com/Events.jsp?pagenum="+pagen+"&count=15'>上一页&nbsp </a>");
                             }  
                          ...
                          <% 
                        	...
                        	try{
                        		...
                        		if(rowCount>pageid*15){
                        			 pagen=pageid+1;
                        			 out.print("&nbsp<a href='/lyxm.xtonegame.com/Events.jsp?pagenum="+pagen+"&count=15'>下一页&nbsp </a>");
