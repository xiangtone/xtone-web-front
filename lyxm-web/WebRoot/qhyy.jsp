...
<script charset="gb2312" type="text/javascript" src="qhyy_files/data.js"></script>
<script src="qhyy_files/report.htm" type="text/javascript"></script>
</head>
<body style="width: 100%; height: auto; margin: 0;">
		...
		<div class="container pa">
			<%
				if (phone == null) {
					...
					out.write("<div style=\"margin-top:10px;margin-left:86.5%;color:#666666;font-size:15px;\">"
			...
			<div class="yy_b_btn1 sp pa"
				...
				<table>
					<tr>
						<td><img src="images/xian_left.png"
							;border=0;height=68px;width=140px></td>
						<td><img src="images/shiyueshoufa.png"></td>
						<td><img src="images/xian_right.png"
							border=0;padding-left=20px></td>
					</tr>
				</table>
			</div>
			...
			<div class="content">
				<div class="content1">
					<div class="box1">
						...
						<p class="num" style="font-size: 30px; color: red">
							已有 <span><%=rowCount%></span> 人预约
						</p>
					</div>
					<div class="box3">
					...
					<div class="box4">
						...
						<ul class="gift_list c">
							<li class="z_index1">
								...
								<table>
									...
									<tr>
										<td><img id="lbbtn2" src="images/gaojibaoxiang.png"></td>
									</tr>
							...
							<li class="z_index2">
								<table>
									...
									<tr>
										<td><img id="lbbtn3" src="images/haohuabaoxiang.png"></td>
									</tr>
							...
							<li class="mr z_index3">
								<table>
									...
									<tr>
										<td><img id="lbbtn4" src="images/zhizunbaoxiang.png"></td>
									</tr>
						...
						<a href="http://www.jiathis.com/share"
							class="jiathis jiathis_txt jiathis_separator jtico jtico_jiathis yq_frid sp"></a>
						<p>&nbsp</p>
						<p class="ck_yq">
							已有<span><%=count%></span>人查看
						</p>
						<div class="ewm_frame">
							<ul class="ewm_list c">
								<li><img src="images/erweima.png" height="180" width="187">
									<p>关注微信公众号</p></li>
	...
	<div class="dialog" id="pop111" role="dialog" tabindex="-1"
		style="display: none; visibility: visible; position: fixed; z-index: 9999; left: 50%; top: 50%; margin-top: -243px; margin-left: -403px;">
		<div
		...
		<div class="pop_con pr"
				...
				<table class="pop_tab">
					<tbody>
						...
						<tr>
							...
							<td><button id="yzmsdl" href="javascript:;"
									class="yzm button small orange"
									style="padding: 1px; font-size: 15px">发送登录码</button></td>
						</tr>
						<tr>
							<td class="tr">登录码：</td>
						...
						<tr>
							...
							<td class="c"><input class="txt pl" type="text" id="code2dl">
							</td>
							<td>
								<div id="vCode2dl"
			...
			<a class="pop_close sp pa" href="javascript:showDialog.hide()"
				title="关闭"
				style="background-image: url(images/guanbianniu.png); background-repeat: no-repeat; background-position: center 0; background-color: transparent; background-size: 100%;"></a>
		</div>
	...
	<div class="dialog" id="qxyy" class="dianji">
		...
		<img id="closebtn" src="images\guanbianniu.png" width="20px"
			align="right" style="margin-left: 800px;"></img>


		<div id="uplbneirong" class="pop_con pr"
			style="position: relative; height: 130px; border: 0; background-image: url(images/dikuan.png); background-repeat: no-repeat; background-position: center 0; background-color: transparent; background-size: 100%;">
	...
	<div class="dialog" id="pop1">
		<div
			...
			<img src="images/kuaisuyuyue.png"></img>
		</div>
		<div class="pop_con pr"
			style="border: 0; background-image: url(images/dikuan.png); background-repeat: no-repeat; background-position: center 0; background-color: transparent; background-size: 100%;">
			<div class="pop">
				...
				<table class="pop_tab">
					<tbody>
						...
						<tr>
							...
							<td><button id="yzms" href="javascript:;"
									class="yzm button small orange"
									style="padding: 1px; font-size: 16px;">发送登录码</button></td>
						</tr>
						<tr>
							<td class="tr">登录码：</td>
	...
	<div class="dialog" id="pop2">
		<div class="pop_con pr">
			<div class="pop pop2">
				...
				<p class="pop2_desp pop2_desp1">
					您的邀请码是： <span id="svnPath"></span><a href="javascript:;"
						id="svnbtn" onclick="" class="btn blue"
						data-clipboard-target="svnPath">复制</a>
				</p>
				<p class="p_line line_b"></p>
				<p class="p_line line_t"></p>
				<p class="pop2_desp">快将邀请码告知您的好友，好友预约成功您可获得惊喜宝箱哦！</p>
				<p class="pop2_desp p_pt">
					方法1：复制邀请码，好友预约时填写；<br> 方法2：用微信或手机QQ扫描下方二维码邀请好友。
				</p>
				<div class="pop2_ewm">
	...
	<div class="dialog" id="pop6">
		<div class="pop_con bx_y pr">
			<p class="ft">
				宝箱将于不删档测试期在游戏内发放，<br>请关注官方信息及时注册领取哦~
			</p>
			<a class="pop_close sp pa" href="javascript:showDialog.hide()"
				title="关闭"></a>
		</div>
		...
		<div class="pop_con pr">
			<div class="pop8">
				...
				<div class="p_pt">
					...
					<p class="pop2_desp ft tc pop8_tl">
						您的邀请码是： <span></span>
					</p>
					<p class="pop2_desp ft tc pop8_tl">
						已邀请：<span></span>人
	...
	<div class="dialog" id="pop10">
		<div class="pop_con pr pop9">
			<p class="ft bx_y2">
				<img src="qhyy_files/qr_dd.png" alt="的的现金券" height="300" width="300">
			</p>
	...
	<div class="dialog" id="pop11">
		<div class="pop_con pr pop9">
			<p class="ft bx_y2">
				<img src="qhyy_files/qr_xc.png" alt="携程现金券" height="300" width="300">
			</p>
	...
	<div class="dialog" id="pop12">
		<div class="pop_con pr pop9">
			<p class="ft bx_y2">
				<img src="qhyy_files/qr_dz.png" alt="大众点评现金券" height="300"
					width="300">
			</p>
	...
	<script>
		...
		var clip = new ZeroClipboard(
				document.getElementById("svnbtn"),
				{
		...
		swfobject.embedSWF("http://qmdzs.qq.com/cp/a20160509gwyy/flash.swf",
				"flash", "100%", "100%", "8.0.0",
				"http://ossweb-img.qq.com/images/swf/expressInstall.swf", null,
				params);
		swfobject.embedSWF("http://qmdzs.qq.com/cp/a20160509gwyy/fsh.swf",
				"fsh", "100%", "100%", "8.0.0",
				"http://ossweb-img.qq.com/images/swf/expressInstall.swf", null,
				params);
	...
	<div
		...
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
			...
			<param name="movie"
				value="http://qmdzs.qq.com/cp/a20160509gwyy/ZeroClipboard.swf?nocache=1467597531174">
			...
			<embed src="qhyy_files/ZeroClipboard.swf" loop="false" menu="false"
				quality="best" bgcolor="#ffffff"
				name="global-zeroclipboard-flash-bridge" allowscriptaccess="always"
				allowfullscreen="false" type="application/x-shockwave-flash"
				wmode="transparent"
				pluginspage="http://www.macromedia.com/go/getflashplayer"
				flashvars="" scale="exactfit" height="100%" width="100%">
		</object>
	</div>

	<script src="js&css/ww_tcss.js"></script>
	<script>if(typeof(pgvMain) == 'function')pgvMain();</script>
	<script src="qhyy_files/qmdzs.htm" type="text/javascript"></script>


	<script type="text/javascript" src="js&css/dr.js">
</script>
	<script type="text/javascript" src="qhyy_files/dr.htm"></script>
	<script src="qhyy_files/qmdzs_002.htm" type="text/javascript"></script>
</body>
</html>
