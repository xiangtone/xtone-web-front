...
<div class="movBtn"><a class="popcl" href="http://sdo-shabake.com/video"></a></div>
                ...
                <div class="conNav">
                    <span>玩法攻略</span>
                    <em><a href="index.jsp">官网首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a>游戏攻略</a></em>
                </div>
                <div class="nW_main">
                    <div class="conMain">
                        <div class="con">
                            ...
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "/lyxm.xtonegame.com/guides?type=1&pagenum="+<%=pageid%>+"&count=10",
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='/lyxm.xtonegame.com/gameplay.jsp?type=1&pagenum="+pagen+"&count=10'>上一页&nbsp </a>");
                             }  
                         ...
                         <% 
                        	...
                        	try{
                        		...
                        		String sql = "SELECT COUNT(1) rowCount FROM tbl_cms_contents  WHERE  status=1 and catalog='play'";
                        		...
                        		if(rowCount>pageid*15){
                        			 pagen=pageid+1;
                        			 out.print("&nbsp<a href='/lyxm.xtonegame.com/gameplay.jsp?type=2&pagenum="+pagen+"&count=15'>下一页&nbsp </a>");
...
<script type="text/javascript">
	   $(document).ready(function(){
		   function showfirst(){
			   $('.nNewsTit li:last a').addClass("active");
			   $('.con #news_0').show();
		   }
