...
<!--         </div> -->
        <div class="block-body">
            <div class="for-bg hide-text" style="background-color:#211f2c;">
                <div  class="list-outer list-outer-1" style="width:100%;height:100%;">
                    <a id="download" href="../downskip?gamenameId=h" class="dl-btn hide-text" onclick="clicknum()"style="width:50%;top:310px;left:25%;"></a>
                </div>
...
<!-- </div>  -->  <div class="block block-news"> 
    ...
    <div class="block-body">
                ...
                <%
                     ...
                     Service.mainnew(out,"select * from tbl_cms_contents where catalog like 'mhxm_%' ORDER BY priority DESC");
...
<!--         <p>投诉邮箱: <a href="mailto:tousu@xindong.com" target="_blank">tousu@xindong.com</a></p> -->
    ...
    <div class="block-header">
        <a class="title custom-btn dl-btn" href="../downskip?gamenameId=h" onclick="clicknum()">立即下载</a>
    </div>
</div>
