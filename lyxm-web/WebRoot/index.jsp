...
<script type="text/javascript" language="javascript"
	src="js&css/jquery-1.js"></script>
<script type="text/javascript" language="javascript"
	src="js&css/base-20151217.js" charset="gb2312"></script>
		...
		<div class="wrapper">
			<div class="w_top">
				...
				<div class="nav">
					...
					<div class="navBtn b4">
						<a href="Strategy.jsp"></a>
					</div>
					<div class="navBtn b5">
						<a
							href="http://tieba.baidu.com/f?ie=utf-8&kw=%E7%81%B5%E5%9F%9F%E4%BB%99%E9%AD%94&fr=search"
							target="_blank"></a>
					</div>
					<div class="navBtn b6">
						<a href="qhyy.jsp" target="_blank"></a>
					</div>
				</div>
				<div class="slogan"></div>

				<div class="movBtn">
					<a class="popcl" href="http://www.sdo-shabake.com/shabake/video"></a>
				</div>
				<div class="topCon">
					<!--轮播开始-->
					<div class="lunbo">
						<div class="imgscroll">
							...
							<div id="picBox" class="imglist">
								<ul style="width: 2200px;">
									<li style="display: none; opacity: 1;" class="imgurl">
										<div class="pic">
											<a href=""></a> <span><img src="images/activity1.jpg"></span>
										</div>
									</li>
									<li style="display: none; opacity: 1;" class="imgurl">
										<div class="pic">
											<a href=""></a> <span><img src="images/activity2.jpg"></span>
										</div>
									</li>
									<li style="display: block; opacity: 1;" class="imgurl">
										<div class="pic">
											<a href=""></a> <span><img src="images/activity3.jpg"></span>
										</div>
									</li>
									<!--                    <li style="display: none; opacity: 1;" class="imgurl"> -->
									<!--                                     <div class="pic"> -->
							...
							<div id="listBox">
								<ul style="width: 140px;" class="roll_l">
									...
									<li class=""><a href="javascript:;" class="roll_t"
										title=""></a></li>
									<li class=""><a href="javascript:;" class="roll_t"
										title=""></a></li>
									<li class=""><a href="javascript:;" class="roll_t"
			...
			<div class="w_main" style="height: 650px;">
				<div class="con1">
					<div class="news">
						...
						<div class="newsTit">
							...
							<div class="newsMore">
								<a target="_blank" href="News.jsp">更多</a>
							</div>
						</div>
						<div class="news_xian">
							<div class="red"></div>
		         ...
		         $(function(){
					...
					<div class="right_pic" style="background: url('images/qqzx.jpg')">
						<div class="ch_bm">
							<img src="images/qq.png" />&nbsp 495265372
						</div>
						<div class="ch_bm1">
							<img src="images/qq.png" />&nbsp 3232698308
						</div>
					</div>
				</div>
				<div class="h_30"></div>
				<div class="con2">
					<div class="bh">
						<a href="Wallpaper.jsp" target="_blank" title="jmbh"></a>
					</div>
					...
					<div class="zy">
						...
						<div class="zy_nav">
							<ul>
								<li class="on2"><a id="a0" class="nav_b0"
									href="javascript:void(0);"></a></li>
								<li><a id="a1" class="nav_b1" href="javascript:void(0);"></a></li>
								<li><a id="a2" class="nav_b2" href="javascript:void(0);"></a></li>
							</ul>
						</div>
						<div style="display: block;" class="zy_con zy_bg0">
							<div class="zy_p">
								...
								<div class="zy_word">
									<p>
										<span>逍遥</span> <em>&nbsp<img src="images/zyjsxybq.png" /></em>
									</p>
						...
						<div class="zy_con zy_bg1">
							<div class="zy_p">
								...
								<div class="zy_word">
									<p>
										<span>狂战</span> <em>&nbsp<img src="images/zyjskzbq.png" /></em>
									</p>
						...
						<div class="zy_con zy_bg2">
							<div class="zy_p">
								...
								<div class="zy_word">
									<p>
										<span>剑灵</span> <em>&nbsp<img src="images/zyjsjlbq.png" /></em>
									</p>
            ...
            -->
				...
				<!--微信二维码浮框-->
				<div class="fr_wx"
					style="position: fixed; left: 50%; margin-left: 600px; bottom: 200px; z-index: 20">
					<div class="fr_ewm_wx">
						<span><img src="images/erweima.jpg"
							style="position: relative; margin-top: 10px; z-index: 1; margin-left: 0px;"
							height="134px" width="134px"></span>
					</div>
				</div>
			...
			<div class="bs-docs-featurette bottom-hieght">
				<div class="container">
					<div class="row home-padding">
						...
						<div id="links"
							style="background-color: rgb(250, 250, 250); padding: 22px; text-align: center; height: auto; overflow:;"
							class="col-md-12 col-sm-12 col-xs-12 nopadding ztgs">
							<script type="text/javascript">
		         $(function(){
			...
			<div class="logox" style="padding-left: 20px;">
				<div class="logo-s" style="padding: 0 50px;">
					...
					<a class="baidux"> <img src="images/footer.png"
						style="border-right: 3px solid grey;" alt=""></a>
				</div>
				<div class="font">
