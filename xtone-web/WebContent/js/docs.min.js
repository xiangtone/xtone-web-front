...
$(function(){
    $("[data-toggle='popover']").popover({
        ...
        content : '<div style="height: 258px;width: 258px;" id="hide"><img style="height: 258px;width: 258px;" src="images/erweima_vanggame.jpg"/></div>', //this is the content of the html box. add the image here or anything you want really.
        animation: false
...
$(function(){
    $("[data-toggle='popover2']").popover({
        ...
        html: 'true', //needed to show html of course
        content : '<img  style="" src="images/erweima_vanggame.jpg"/>', //this is the content of the html box. add the image here or anything you want really.
        animation: false
    })
});
/*热门游戏*/
