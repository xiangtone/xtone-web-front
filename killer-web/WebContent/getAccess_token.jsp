<%@page import="org.killer.dao.QqxzCodeDAO"%>
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
		...
		String userCode = "";
		QqxzCodeDAO dao = new QqxzCodeDAO();
...
<div class="content" style="width: 100%;">
  <div class="news_detail_title" style="margin: 0px 5px -2px 5px;"> 
  	...
  	<div style="float: left; margin-top: 15px;margin-left: 10px;">
  		<p style="font-size: 15px;" align="left">《苍穹仙尊》</p>
...
<div>&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">100元宝</span></span></span></div><div style="line-height: 0px">&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">破军剑</span></span></span></div><div style="line-height: 0px">&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">4级宝石袋一个</span></span></span></div><div style="line-height: 0px">&nbsp;</div>
