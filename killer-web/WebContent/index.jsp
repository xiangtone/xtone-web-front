<%@page import="org.killer.service.Service"%>
        ...
        <div class="block-body">
            <div class="for-bg hide-text" style="background-color:#211f2c;">
                <div  class="list-outer list-outer-1" style="width:46.875%;height:12%;">
                    <a id="download" href="downskip?gamenameId=k" class="dl-btn hide-text"></a>
                </div>
...
<!--             </a> -->
    ...
    <div  style="padding-top: 6.625%; text-align: center;overflow: auto;background-color: rgb(72,44,44);">
        ...
        <a href="downskip?gamenameId=k" style="display:block;"><img src="img/button_dl2.png" width="90%"/></a><br/>
        <a href="" style="display:block;padding-bottom: 5%;"><img src="img/button_more.png" width="90%"/></a>
    </div>
</div>
