...
//		                replyMsg.append("\r\n其他、回音壁请直接输入文字信息");
		                 ...
		                 if(receive.equals("梦幻仙魔")){
		                	String code = wechatservice(textMsg.getFromUserName().trim(), "menghuanxianmo");
		                	 replyMsg.append("\r\n"+code);
		                 }
		            	 ...
		            	 replyMsg.append("<h1 style=\"color:red;\">领取礼包兑换码请输入正确的游戏名称!</h1>");
	...
	public static String sort(String token, String timestamp, String nonce) {
	 ...
	 private String wechatservice(String openId,String gameName){
			...
			String userCode = "";
			Long codeForOpenId = dao.checkOpenId2(openId,gameName);
//			System.out.println(codeForOpenId);
//			System.out.println(openId);
			if(codeForOpenId>0){
				userCode = codeForOpenId+"";
			}else{
				Long CodeNumber = dao.checkGameId2(gameName);
