...
<%@page import="com.system.database.CodeDAO"%>
<%@page import="com.xtone.util.CheckLoad"%>
<%@page import="org.demo.info.Message"%>
<%@page import="com.google.gson.Gson"%>
<%@page import="com.xtone.util.HttpsRequest"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	String resours = (String)req.sendGet("https://api.weixin.qq.com/cgi-bin/user/info?access_token=y4loh9109Jc8MzlbwTOCgSpnFDKRjGKvkVi_xq_CguX9Au4DQpriHzFas-YK4VdA2p_knYOl95wu1_JM1LviGGnMiHUtbEnUIimea49-zR3a4RwfeLBWMNfFV2pMKhg3LGDcADASNK&openid=o28_Sv9EUNCmNmn3NjN7lw9TdxXo");
    	String userCode = resours;
...
<div class="content" style="width: 100%;">
  <div class="news_detail_title" style="margin: 0px 5px -2px 5px;"> 
  	<img alt="" src="../js-css/code/icon.png" style="width: 65px; height: 65px;margin: 10px 8px 0px 15px;float: left;">
  	<div style="float: left; margin-top: 15px;margin-left: 10px;">
  		<p style="font-size: 15px;" align="left">《梦想昆仑》</p>
  		<p style="font-size: 15px;" align="left">微信感谢礼包</p>
...
<div>&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">5张铜币卡（中）</span></span></span></div><div style="line-height: 0px">&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">20个低级成长丹</span></span></span></div><div style="line-height: 0px">&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">5个复活丹</span></span></span></div><div style="line-height: 0px">&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">5个修为丹（大）</span></span></span></div>
<div>&nbsp;</div>
...
<div>&nbsp;</div>
<div style="margin-left: 20px"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">1、</span></span></span><span style="color: rgb(0, 0, 0);line-height: 0px;"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;word-break:normal; ">在游戏主界面点击奖励-领取礼包-输入激活码领取&nbsp;</span></span></span></div><div>&nbsp;</div>

<div style="margin-left: 20px;line-height: 0px;"><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">2、</span></span></span><span style="color: rgb(0, 0, 0);"><span style="font-family: 微软雅黑;"><span style="font-size: 14px;">一个微信号只能领取一个礼包&nbsp;</span></span></span></div>
<div>&nbsp;</div>
<div>&nbsp;</div>
