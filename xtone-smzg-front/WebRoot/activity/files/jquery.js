    ...
    if ($.isFunction(options)) {
		...
		function open(){
            ...
            $popup
				...
				.css({ 'left': o.transition === 'slideIn' ? (hPos + width) *-1 : getLeft(!(!o.follow[0] && fixedHPos || fixedPosStyle)), 'position': o.positionStyle || 'absolute', 'top': 0, 'z-index': o.zIndex + popups + 1 })
				.each(function() {
            		if(o.appending) {
