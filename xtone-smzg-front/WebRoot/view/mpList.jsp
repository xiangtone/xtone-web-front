...
<%@page import="com.xtone.util.MobilePageUtil"%>
<%@page import="com.xtone.util.Constant"%>
...
<%
	...
	String type = StringUtil.getString(request.getParameter("catalog"), "");
	...
	if(!type.equals("first")){
		try{
			...
			String limit = " limit "+Constant.MOBILE_PAGE_SIZE*(pageIndex-1) + "," + Constant.MOBILE_PAGE_SIZE;
			String sql = "SELECT id,`title`,`lastModifyTime`,`catalog` FROM `tbl_cms_contents` WHERE `catalog` LIKE ? AND `status`=1 "+limit;
			...
			sql = "SELECT count(*) count FROM `tbl_cms_contents` WHERE `catalog` LIKE ? AND `status`=1 ";
			ps = con.prepareStatement(sql);
			ps.setString(1, type);
			rs = ps.executeQuery();
			if(rs.next())
		...
		try{
			...
			//sql = "SELECT count(*) count FROM `tbl_cms_contents` ";
			//ps = con.prepareStatement(sql);
			//rs = ps.executeQuery();
			//if(rs.next())
				//count = rs.getInt(1);
...
<link rel="stylesheet" href="../js-css/mp_list/index.css">
<script charset="gb2312" type="text/javascript" src="../js-css/mp_list/jquery(mixNIE).last.js"></script>
<script charset="gb2312" type="text/javascript" src="../js-css/mp_list/index2.js"></script>
</head>
<body>
...
<header class="header">
    <div class="top-bar">
    	...
    	%>
        <div class="con-tit"><a href="javascript:;"><%=type2 %></a></div>
        ...
        <div class="logo fl" style="background: transparent url('../img/mp_list/back.png') no-repeat scroll left center / 20px auto;"><a href="javascript:history.back(-1);"></a></div>
    </div>
...
<article class="content">
    	...
    	<div class="gameinfo-mod clear">
			<figure>
						<div class="top-bar2">
							...
							<div class="fr"><a class="mod-tit1" style="background: transparent url('../img/mp_list/main_logo.png') no-repeat scroll center center / auto 25px;" href="mpLoad.jsp"><!--<i class="sign" id="nav_forum" onclick="headerToggle()"></i>--></a></div>
							<div class="logo fl" style="background: transparent url('../img/mp_list/ico.png') no-repeat scroll left center / 40px auto;"><a href="javascript:;"></a></div>
						</div>
						<nav class="nav-bar" id="j_head_nav" style="display:none;">
						<div class="t">
							<div style="float:right; width:50%; margin-top:2px;">
    ...
    <!--mod-frame-1-->
    <section class="re-mod mod-frame-1" style="padding-bottom:0px;-background: rgb(255, 255, 255) none repeat scroll 0% 0%;background: #5C095A none repeat scroll 0% 0%;">
        <div class="content_list_wrap">
            	...
            	<%	
                        ...
                        <a href="mpContent.jsp?id=<%=news.getId() %>" ><em><%=catalog %> </em><%=news.getTitle() %></a>
                ...
                <div class="pageNum">
                   <!--   <p>
                        ...
                        1<a href="http://smzg.xtonegame.com/new/first/index2.html">
                        ...
                        <a href="http://smzg.xtonegame.com/new/first/index2.html">下一页</a>

                    </p>-->
                    <%
						MobilePageUtil util = new MobilePageUtil();
						String result = util.initPageQuery("mpList.jsp", null , count, pageIndex,type);
    ...
    <section class="re-mod mod-frame-1">
        <figure>
			<a href="../view/mpContent.jsp?id=213" style="color: #20202C;text-decoration: none;display: block;width: 34%;height: 43px;-top: 70%;background: transparent url(../img/mp_list/btn_download.jpg) no-repeat scroll left center / 98px auto;position: absolute;left: 13%;margin-top: 6%;"></a>
			<a style="color: #20202C;text-decoration: none;display: block;width: 34%;height: 43px;-top: 70%;background: transparent url(../img/mp_list/btn.jpg) no-repeat scroll left center / 98px auto;position: absolute;left: 58%;margin-top: 6%;-bottom: -50%;" href="javascript:openPop('#pop-android');"></a>
		  ...
		  <img src="../img/mp_list/bottom.png" alt="花千骨" style="width: 100%;">
