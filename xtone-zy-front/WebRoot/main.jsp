...
<style type="text/css">
	...
	#NIE-topBar,#NIE-topBar-include{
		...
		.partner p{padding: 6px 0px 2.5px 50px;}
...
<div class="model2" style="width:100%;min-width:1500px;;">
	...
	<div class="partner" >
	    <div style="width:1170px;margin-left:-2%">
		<p style="color:rgb(109, 109, 109);padding: 5px 0px 2.5px 50px;font-size: 20px;font-weight:880;">	
