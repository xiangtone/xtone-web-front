...
<html><head>
    ...
    <link type="text/css" rel="stylesheet" href="../js-css/news/newDetail_79f84a9.css">
...
<!-- </div> -->
<!--This is Git Project-->
<!-- <div class="comdiv" style="position:absolute;width:100%;height:15%;z-index:9999;background:rgba(0,0,0,0.15);filter:progid:DXImageTransform.Microsoft.gradient(enabled='true',startColorstr='#7F000000',endColorstr='#7F000000');"> -->
<!--    <ul class="menu"> -->
<!--         <li ><a href="../index.jsp" id="home"></a></li> -->
<!-- 		<li><a href="news.jsp" id="news"></a></li> -->
<!-- 		<li><a href="material.jsp" id="material"></a></li> -->
<!-- 		<li><a href="#" id="public"></a></li> -->
<!--       </ul> -->

<!-- </div> -->

<div class="comdiv" style="position:absolute;width:100%;min-width:1280px;height:110px;z-index:9999;background:rgba(0,0,0,0.15);filter:progid:DXImageTransform.Microsoft.gradient(enabled='false',startColorstr='#7F000000',endColorstr='#7F000000');padding:0 auto;margin: 0 auto;">
   <ul class="menu">
        <li ><a href="../index.jsp" id="home"></a></li>
		<li><a href="news.jsp" id="news"></a></li>
		<li><a href="material.jsp" id="material"></a></li>
 ...
 <div class="test-top-main" id="NIE-topBar-main">
    ...
    <div class="wrap" style="    background: transparent url(../img/news/bg.png) no-repeat scroll center 0px;background-size:100%;">
            ...
            <div class="content-wrap" style="margin-left: 0%;">
                ...
                <div class="content_nav" style="width: 92%;height: 68px;margin-left: 33px;border-bottom: 1px solid #EBEDEE;clear: both;">
                    <ul class="navList" style="width:761px;height:67px;margin_left:33px;boder_bootom:1px solid rgb(235,237,238);">
                        ...
                        <li style="border-bottom: 2px solid #9d8d87;float: left;width: 116px;height: 66px;text-align: center;line-height: 80px;font-size: 18px;"><a id="news2" href="news.jsp" style="color: #9d8d87;display: block;width: 100%;height: 100%;">新闻</a></li>
                ...
                <div class="content_list_wrap">
                    <ul>
                        ...
                        <a href="content.jsp?id=<%=news.getId() %>" ><em>【新闻】 </em><%=news.getTitle() %></a>
