        ...
        <div class="right-wrap">
            <div class="content-wrap" style="margin-left: 0%;">
                ...
                <div class="content_title" style="-background: url(../img/news/title_bg.png) 50% 0px no-repeat;">
                    ...
                    <span>当前位置：<a href="../index.jsp">官网首页</a> &gt; 新闻中心</span>
                </div>
                ...
                <div class="content_nav" style="width: 92%;height: 68px;margin-left: 33px;border-bottom: 1px solid #EBEDEE;clear: both;">
                    <ul class="navList" style="width:761px;height:67px;margin_left:33px;boder_bootom:1px solid rgb(235,237,238);">
                        <li class="active" style="border-bottom: 2px solid #9d8d87;float: left;width: 116px;height: 66px;text-align: center;line-height: 80px;font-size: 18px;"><a id="first" href="first.jsp" style="color: #9d8d87;display: block;width: 100%;height: 100%;">最新</a></li>
                ...
                <div class="content_list_wrap">
                    <ul>
                        ...
                        <a href="content.jsp?id=<%=news.getId() %>" ><em><%=catalog %> </em><%=news.getTitle() %></a>
