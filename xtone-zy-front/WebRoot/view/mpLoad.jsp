...
<link rel="stylesheet" href="../js-css/mp_load/index.css">
<script charset="gb2312" type="text/javascript" src="../js-css/mp_load/jquery(mixNIE).last.js"></script>
<script charset="gb2312" type="text/javascript" src="../js-css/mp_load/index2.js"></script>
</head>
<body>
...
<header class="header">
    <div class="top-bar">
        <div class="con-tit"><a href="javascript:;">神魔战歌</a></div>
        <div class="fr"><span class="mod-tit1"><i class="sign" id="nav_forum" onclick="headerToggle()"></i></span></div>
        <div class="logo fl" style="background: transparent url('../img/mp_load/ico.png') no-repeat scroll left center / 40px auto;"><a href="javascript:;"></a></div>
    </div>
...
<article class="content">
    ...
    <section class="re-mod">
    	<div class="gameinfo-mod clear">
			<figure>
						...
						<img src="../img/mp_load/top.png" alt="神魔战歌">
				...
				<ul class="re-imgtext-15 clear">
					...
					<li>
						<a style="color: #20202C;text-decoration: none;display: block;width: 34%;height: 43px;top: 70%;background: transparent url(../img/mp_load/btn.jpg) no-repeat scroll left center / 98px auto;position: absolute;left: 58%;" href="javascript:openPop('#pop-android');"></a>
					</li>
				</ul>
				<!--android-->
    ...
    <!--mod-frame-1-->
    <section class="re-mod mod-frame-1" style="padding-bottom:0px;">
        <div class="HotNewsBox" style="font-family:'微软雅黑';">
		<div class="tabNav" style="background: rgb(92, 9, 90) none repeat scroll 0% 0%;">
            <ul id="news_nav">
             <li class="current" style="margin:0;padding:0px 0px 0px 5px;"><a title="综合" href="javascript:;">综合</a></li>
              <li class=""><a title="神魔战歌新闻"  href="javascript:;">新闻</a> </li>
              <li class=""><a title="神魔战歌公告"  href="javascript:;">资料</a></li>
              <li class="" ><a title="神魔战歌活动"  href="javascript:;">论坛</a></li>
            </ul>

          </div>
		  <div class="news_nr" style="display: block;">
            <ul class="newsList">
            	<!-- <li><a href="javascript:;" class="tit" data="0" title="11月10日更新公告" >【公告】</a>
				<a href="javascript:;" target="_blank" title="11月10日更新公告">11月10日更新公告</a>
				<font >[11/09]</font>
				</li>
                               		<li><a href="javascript:;" class="tit" data="0" title="神魔战歌攻略： 如何完美通关英灵试炼40层" >【综合】</a><a href="javascript:;" target="_blank" title="神魔战歌攻略： 如何完美通关英灵试炼40层">神魔战歌攻略： 如何完美通关英灵试炼40层</a><font>[11/13]</font></li>
                               		<li><a href="javascript:;" class="tit" data="0" title="11月6日-11月7日App Store活动" target="_blank">【综合】</a><a href="javascript:;" target="_blank" title="11月6日-11月7日App Store活动">11月6日-11月7日App Store活动</a><font>[11/05]</font></li>
                               		<li><a href="javascript:;" class="tit" data="0" title="11月3日-11月5日App Store活动" target="_blank">【综合】</a><a href="javascript:;" target="_blank" title="11月3日-11月5日App Store活动">11月3日-11月5日App Store活动</a><font>[11/02]</font></li>
                               		<li><a href="javascript:;" class="tit" data="0" title="10月31日-11月2日App Store活动" target="_blank">【综合】</a><a href="javascript:;" target="_blank" title="10月31日-11月2日App Store活动">10月31日-11月2日App Store活动</a><font >[10/31]</font></li></ul> -->
                 <%
            	String catalog="";
            	for(News news : list){
				...
				<a href="mpContent.jsp?id=<%=news.getId() %>"  title="<%=news.getTitle()%>"><%=news.getTitle() %></a>
				<font >[<%=timeStr %>]</font>
				</li>
				<%} %>
			<!-- <div class="active" style="margin:18px 13px 13px 29px;">
				<a href="javascript:;" style="display: block;height: 30px;width: 80%;background: rgb(188, 100, 177) none repeat scroll 0% 0%;left: 10%;margin-left: 6%;text-align: center;line-height: 200%;">查看更多</a>
			</div> -->
			</ul>
			<div class="active" style="margin:18px 13px 13px 29px;">
				<a href="mpList.jsp?catalog=first" style="display: block;height: 30px;width: 80%;background: rgb(188, 100, 177) none repeat scroll 0% 0%;left: 10%;margin-left: 6%;text-align: center;line-height: 200%;">查看更多</a>
			</div>
          </div>
			...
			<div class="active" style="margin:18px 13px 13px 29px;">
				<a href="mpList.jsp?catalog=news" style="display: block;height: 30px;width: 80%;background: rgb(188, 100, 177) none repeat scroll 0% 0%;left: 10%;margin-left: 6%;text-align: center;line-height: 200%;">查看更多</a>
			</div>
          <!--/-->
          </div>
			<div style="display: none;" class="news_nr">
			...
			<div class="active" style="margin:18px 13px 13px 29px;">
				<a href="mpList.jsp?catalog=material" style="display: block;height: 30px;width: 80%;background: rgb(188, 100, 177) none repeat scroll 0% 0%;left: 10%;margin-left: 6%;text-align: center;line-height: 200%;">查看更多</a>
			</div>
          </div>
          <div style="display: none;" class="news_nr">
            <ul class="newsList">
				...
				<div class="active" style="margin:18px 13px 13px 29px;">
				<a href="mpList.jsp?catalog=forum" style="display: block;height: 30px;width: 80%;background: rgb(188, 100, 177) none repeat scroll 0% 0%;left: 10%;margin-left: 6%;text-align: center;line-height: 200%;">查看更多</a>
			    </div>
          <!--/-->
          </div>
    ...
    <section class="re-mod mod-frame-1">
        <figure>
		  <img src="../img/mp_load/bottom.jpg" alt="神魔战歌" style="width: 100%;">
		</figure>
    </section>
