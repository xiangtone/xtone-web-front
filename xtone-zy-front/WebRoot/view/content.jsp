...
<div class="nav">
      ...
      <ul class="menu">
		...
		<li ><a href="forum.jsp" id="forum"></a></li>
                    ...
                    %>
<!--This is Git Project-->
    <div class="wrap" style="    background: transparent url(../img/content/bg_1.jpg) no-repeat scroll center 0px;">
        <div class="right-wrap">
            <div class="content-wrap" style="margin-left: 0%;">
                <div class="content_title" style="background: transparent url(../img/content/title_bg.png) no-repeat scroll center 0px;">
                    <div class="title" style="background: transparent url(../img/content/<%=news.getCatalog() %>.png) no-repeat scroll center 0px;"></div>
                    
                    <span>当前位置：<a href="main.jsp">官网首页</a> &gt; <%=catalog %></span>
                </div>
                <div id="NIE-art">
