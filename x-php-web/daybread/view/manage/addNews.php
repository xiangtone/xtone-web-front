...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >新闻资讯添加页面</th>
  </tr>
  <tr>
    <td class="CPanel">
        ...
        <TR>
			...
			<tr>
                ...
                <td><input name="ntitle" class="text" style="width:550px" type="text" size="40" />
                <span class="red"> * </span></td>
            </tr>
			
			<tr>
                <td align="right">来源:</td>
                <td><input name="nsource" class="text" style="width:550px" type="text" size="40" /></td>
            </tr>
			...
			<tr>
				...
				<td id="gaType">
                	<select name="ntype" style="height:25px;" id="ntype">
                    	...
                    	<option value="<?php echo $val['ntid']; ?>"><?php echo $val['ntName']; ?></option>
                        <?php }} ?>
                    </select>
            ...
            <tr>
                ...
                <td colspan="3"><textarea  name="ninfor" rows="6" cols="120"></textarea></td>
            </tr>
			
           
			<tr>
                <td align="right" height="120px">新闻资讯内容:</td>
                <td colspan="3"><textarea id="editor_id" name="ncontent" rows="50" cols="150"></textarea></td>
            </tr>
