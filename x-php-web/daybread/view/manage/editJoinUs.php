...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >招聘信息编辑页面</th>
  </tr>
  <tr>
    <td class="CPanel">
        ...
        <TR>
			...
			<tr>
                ...
                <td><input name="title" class="text" value="<?php echo $Row['title']; ?>" style="width:550px" type="text" size="40" />
                <span class="red"> * </span></td>
            </tr>
			
			<tr>
                <td align="right">招聘城市:</td>
                <td><input name="area" class="text" value="<?php echo $Row['area']; ?>" style="width:550px" type="text" size="40" /><span class="red"> * </span></td>
            </tr>
			
			<tr>
                <td align="right">招聘日期:</td>
                <td><input name="theDate" class="text" value="<?php echo $Row['theDate']; ?>" style="width:550px" type="text" size="40" /><span class="red"> * </span></td>
            </tr>
			
			<tr>
                <td align="right">招聘公司:</td>
                <td><input name="company" class="text" value="<?php echo $Row['company']; ?>" style="width:550px" type="text" size="40" /><span class="red"> * </span></td>
            </tr>
           
			<tr>
                <td align="right" height="120px">招聘信息内容:</td>
                <td colspan="3"><textarea id="editor_id" name="content" rows="50" cols="150"><?php echo $Row['content']; ?></textarea></td>
            </tr>
