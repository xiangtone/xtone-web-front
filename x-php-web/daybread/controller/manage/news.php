...
class news extends Controller {
	...
	public function addNews(){
		...
		if($_POST){
			...
			$DB->insert('news', 'ntitle,ntype,ntName,ninfor,nsource,ncontent,nstatus,ncreateTime', "'$ntitle','$ntype','$ntName','$ninfor','$nsource','$ncontent','$nstatus','$ncreateTime'", 'index.php?app=manage&controller=news&action=listNews');exit;
	...
	public function editNews(){
		...
		if($_POST){
			...
			$DB->update('news', "ntitle='$ntitle',ntype='$ntype',ntName='$ntName',ninfor='$ninfor',nsource='$nsource',ncontent='$ncontent',nstatus='$nstatus',ncreateTime='$ncreateTime'", 'nid='.$nid,'index.php?app=manage&controller=news&action=listNews');exit;
