...
<div id="navpart" class="navpart-cases">
	<ul>
        ...
        <li class="hover current-cat"><a href="index.php?controller=cases&action=brand" class="last">品牌设计</a></li>
    </ul>
</div>
<div id="head-navpart">
  <ul>
...
<?php include('footer.php'); ?><script src="js/jquery.brand.js" type="text/javascript"></script>
