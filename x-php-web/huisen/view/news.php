...
<div id="content">
    <div id="news_list">		
        <div id="tab_a">
            <li><a href="index.php?controller=about&action=news" class="current">公司新闻</a></li>
            <li><a href="index.php?controller=about&action=industry">行业动态</a></li>
        </div>
        <div id="list-wrap">
            <div id="company">
			...
			<!--<div id="page">
                <a href="javascript:void(0);" title="已经是第一页了!" class="prveNO">&nbsp;</a><a href="#" class="current">1</a><a href="�page=2.html">2</a><a href="#">3</a><span class="pageell">……</span><a href="#">28</a><a href="�page=29.html">29</a><a href="�page=2.html" title="查看下一页！" class="next">&nbsp;</a>            
            </div>-->
        </div>
    </div>
</div>
