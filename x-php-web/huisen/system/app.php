...
final class Application {
        ...
        public static function routeToCm($url_array = array()){
                ...
                if(isset($url_array['controller'])){
                        ...
                        if($app){
                                $controller_file = CONTROLLER_PATH.'/'.$app.'/'.$controller.'.php';
                        ...
                        if($app){
                                $controller_file = CONTROLLER_PATH.'/'.$app.'/'.self::$_config['route']['default_controller'].'.php';
                                $model_file = MODEL_PATH.'/'.$app.'/'.self::$_config['route']['default_controller'].'Model.php';
                        }else{
                                $controller_file = CONTROLLER_PATH.'/'.self::$_config['route']['default_controller'].'.php';
