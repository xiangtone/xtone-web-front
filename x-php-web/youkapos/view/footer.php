<div id="boot">
  <div class="quick">
    <ul>
      <li class="site">
        <p>
            <a href="index.php?controller=solution" class="title">解决方案</a>
        ...
        <p>
            <a href="index.php?controller=product" class="title">产品&amp;服务</a>
        ...
        <p>
            <a href="index.php?controller=cases" class="title">案例&amp;体验</a>
        ...
        <p>
            <a href="index.php?controller=service" class="title">服务&amp;支持</a>
        ...
        <p class="noseparated">
            <a href="index.php?controller=about" class="title">关于我们</a>
            <a href="index.php?controller=about">企业简介</a>
            <a href="index.php?controller=about&action=superiority">我们的优势</a>
            <a href="index.php?controller=about&action=news.php.html">资讯动态</a>
            <!--<a href="#" target="_blank">Weibo/微博</a>-->
            <a href="index.php?controller=about&action=contact">联系方式</a>
        </p>
      </li>
      <li class="Two-dimensional-code"><img src="images/web/Two-dimensional-code.jpg" /></li>
    </ul>
  </div>
  <div class="contact">
    <ul>
      ...
      <li>
        <p>
        <div id="share" class="bshare-custom icon-medium">
        <div class="bsPromo bsPromo2"></div>
        <a title="分享到微信" class="bshare-weixin" href="javascript:void(0);"></a><a title="分享到腾讯微博" class="bshare-qqmb" href="javascript:void(0);"></a>
        <a title="分享到新浪微博" class="bshare-sinaminiblog" href="javascript:void(0);"></a><a title="分享到QQ空间" class="bshare-qzone"></a>
        <a title="分享到人人网" class="bshare-renren"></a><a title="更多平台" class="bshare-more bshare-more-icon more-style-addthis"></a>
        </div>
		<script src="http://static.bshare.cn/b/buttonLite.js#style=-1&uuid=&pophcol=2&lang=zh" type="text/javascript" charset="utf-8"></script><script src="../static.bshare.cn/b/bshareC0.js" type="text/javascript" charset="utf-8"></script>
        </p>
      </li>
    </ul>
  </div>
  <div class="copy">
    <div>&copy; 2013-2018  深圳市有卡科技有限公司  版权所有。&nbsp;&nbsp; ICP备案证书号:<a href="http://www.miitbeian.gov.cn">粤ICP备14062889号-1</a></div>
  </div>
</div>
