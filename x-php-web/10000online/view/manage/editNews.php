    ...
    <td class="CPanel">
        ...
        <TR>
			...
			<tr>
                ...
                <td><input name="ntitle" value="<?php echo $Row['ntitle']; ?>" class="text" style="width:550px" type="text" size="40" />
                <span class="red"> * </span></td>
            </tr>
			
			<tr>
                <td align="right">来源:</td>
                <td><input value="<?php echo $Row['nsource']; ?>" name="nsource" class="text" style="width:550px" type="text" size="40" /></td>
            </tr>
