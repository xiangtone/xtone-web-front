...
<title>捷酷软件-国际领先的移动游戏开发商与发行商</title>
...
<div class="wrap"><!--colum-->
  ...
  <div class="colum"><!-- 新闻动态 -->
    <div class="news indexnew1">
      <div class="hd"><a href="index.php?controller=news">更多测评</a>
        <h3>游戏测评</h3>
      </div>
      <dl class="dl3">
        <dt><img src="./images/1427968274_1525197333.jpg" alt="">
    ...
    <div class="ppxc">
      ...
      <div class="bd">
        <div class="ppxc_top"><span><img src="./images/erweima.png" alt=""></span>
          <h3>广州捷酷软件开发有限公司拥有国内较早从事手机网游研发、运营、发行的管理团队，凭借敏锐的市场嗅觉，深厚的行业积累享誉业内。</h3>
        </div>
        <div class="ppxc_p">
          <p><b>联系电话：</b>020-28107007</p>
          <p><b>客服邮箱：</b>13710418281@139.com</p>
        </div>
      </div>
    </div>
  </div>
