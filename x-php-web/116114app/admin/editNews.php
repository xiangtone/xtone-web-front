...
$nid = $_GET['nid'];
$sqlOne = "select * from news where id='$nid'";
...
if($_POST){
	...
	$rst =  $sqlsrv->update("news",$Arr,"id = '$nid'");

	
	if($rst){
		echo '<script type="text/javascript">alert("修改成功");location.href="listNews.php";</script>';
	}else{
		echo '<script type="text/javascript">alert("修改失败");location.href="listNews.php";</script>';	
	}
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >新闻编辑页面</th>
  </tr>
  <tr>
    <td class="CPanel">
        ...
        <TR>
            ...
            <tr>
                ...
                <td>
                	<select name="ntype" style="height:25px; width:100px;">
                    	<option value="1" <?php if($ArrRow['ntype'] == 1){ echo 'selected="selected"';} ?>>新闻</option>
                    	<option value="2" <?php if($ArrRow['ntype'] == 2){ echo 'selected="selected"';} ?>>测评</option>
                    </select>
                </td>
            </tr>
			...
			<tr>
                ...
                <td><input name="title" class="text" style="width:650px" value="<?php echo $ArrRow['title']; ?>" type="text" size="100" />
                <span class="red"> * </span></td>
            </tr>
            
            <tr>
                <td align="right">来源:</td>
                <td><input name="source" value="<?php echo $ArrRow['source']; ?>" class="text" style="width:650px" type="text" size="100" /></td>
            </tr>
           ...
           <tr height="20"><td></td><td></td></tr>
			<tr>
                ...
                <td colspan="3"><textarea  id="editor_id" name="content" rows="50" cols="150"><?php echo $ArrRow['content']; ?></textarea></td>
            </tr>
