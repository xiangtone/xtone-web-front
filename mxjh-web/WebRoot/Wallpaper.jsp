    ...
    <div class="navBtn b6"><a href="qhyy.jsp"></a></div>
                ...
                <div class="conNav">
                      <span style="color:#ffdb94">精美壁纸</span>
                       <em>您的位置：<a href="indexIn.jsp">官网首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a>精美壁纸</a></em>
                </div>
                <div class="nW_main">
                    <div class="conMain">
                        <div class="con" style="background:#CCCCCC;">
                            ...
                            <div class="nNewsTit">
                                ...
                                <li class="" id="nli_0" style="margin-top:30px;"><img src="img/fengexianbg.png"></li>                               
                                </ul>
                            </div>
                            ...
                            <!-- 新闻类别按钮 结束-->
                            <!-- 新闻列表 开始-->
                            <div id="news_0" style="display:block;margin-left:-10px" class="wallpaperMain">
                            <ul style="display:block;margin-left:-5px">
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "Selnews?type=31&page="+<%=pageid %>+"&count=4",
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='Wallpaper.jsp?type=1&pagenum="+pagen+"&count=4'>上一页&nbsp </a>");
                             }  
                           ...
                           %>
                        	...
                        	try{
                        		...
                        		if(rowCount>pageid*4){
                        			 pagen=pageid+1;
                        			 out.print("&nbsp<a href='Wallpaper.jsp?type=1&pagenum="+pagen+"&count=4'>下一页&nbsp </a>");
