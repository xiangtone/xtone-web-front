...
<<<<<<< HEAD
                    <span>精彩活动</span>
                    <em><a href="index.jsp">官网首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a>精彩活动</a></em>
=======
                    <span style="color:#ffdb94">精彩活动</span>
                    <em>您的位置：<a href="index.jsp">官网首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a>精彩活动</a></em>
>>>>>>> master
                </div>
                <div class="nW_main">
                    <div class="conMain">
                            ...
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "Selnews?type=11&pagenum="+<%=pageid%>+"&count=10",
...
>>>>>>> master
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='Events.jsp?pagenum="+pagen+"&count=15'>上一页&nbsp </a>");
                             }  
                          ...
                          <% 
                        	...
                        	try{
                        		...
                        		if(rowCount>pageid*15){
                        			 pagen=pageid+1;
                        			 out.print("&nbsp<a href='Events.jsp?pagenum="+pagen+"&count=15'>下一页&nbsp </a>");
