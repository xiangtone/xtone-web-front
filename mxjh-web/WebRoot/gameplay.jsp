                        ...
                        <div class="con">
                            ...
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "Selnews?type=22&pagenum="+<%=pageid%>+"&count=10",
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='gameplay.jsp?type=1&pagenum="+pagen+"&count=10'>上一页&nbsp </a>");
                             }  
                         ...
                         <% 
                        	...
                        	try{
                        		...
                        		if(rowCount>pageid*15){
                        			 pagen=pageid+1;
                        			 out.print("&nbsp<a href='gameplay.jsp?type=2&pagenum="+pagen+"&count=15'>下一页&nbsp </a>");
