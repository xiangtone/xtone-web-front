...
<div class="movBtn"><a class="popcl" href="http://sdo-shabake.com/video"></a></div>
                ...
                <div class="conNav">
                    ...
                    <em>您的位置：<a href="indexIn.jsp">官网首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a>新闻公告</a></em>
                </div>
                <div class="nW_main">
                    <div class="conMain">
                        <div class="con">
                            ...
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "Selnews?type=02&pagenum="+<%=pageid%>+"&count=10",
                           ...
                           <%
                             ...
                             out.print("&nbsp<span class='de_prev'>上一页&nbsp </span>");
                            	 ...
                            	 pagen=pageid-1;
                            	 out.print("&nbsp<a href='announce.jsp?type=3&pagenum="+pagen+"'>上一页&nbsp </a>");
                             }  
                           ...
                           <% 
                        	...
                        	try{
                        		...
                        		if(rowCount>pageid*15){
                        			 pagen=pageid+1;
                        			 out.print("&nbsp<a href='announce.jsp?type=3&pagenum="+pagen+"&count=15'>下一页&nbsp </a>");
