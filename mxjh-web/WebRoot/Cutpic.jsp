...
<div class="movBtn"><a class="popcl" href="http://sdo-shabake.com/video"></a></div>
                ...
                <div class="conNav">
<<<<<<< HEAD
                    <a href="Wallpaper.jsp"><span id="btn1">&nbsp</span></a>
                       <span id="btn2">&nbsp</span>
                    <em><a href="index.jsp">官网首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a>游戏截图</a></em>
=======
                   <span style="color:#ffdb94">游戏截图</span>
                    <em>您的位置：<a href="index.jsp">官网首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a>游戏截图</a></em>
>>>>>>> master
                </div>
                <div class="nW_main">
                    <div class="conMain">
                        <div class="con" style="background:#CCCCCC">
                            <!-- 新闻类别按钮 开始-->
                            <div class="nNewsTit">
                                <ul>
                                
                                <li class="" id="nli_0" style="margin-top:30px;"><img src="img/fengexiancut.png"></li>                               
                                </ul>
                            </div>
                            ...
                            <!-- 新闻类别按钮 结束-->
                            <!-- 新闻列表 开始-->
                            <div id="news_0" style="display:block; margin-left:-13px;" class="wallpaperMain">
                            <ul>
                              <script type="text/javascript">
                                $(document).ready(function(){
                                  $.ajax({
                                    type: "GET",
                                      url: "Selnews?type=32&page="+<%=pageid %>+"&count=4",
                           ...
                           %>
                        	...
                        	try{
                        		...
                        		String sql = "SELECT COUNT(1) rowCount FROM tbl_cms_contents WHERE status=1 and catalog='cutpic'";
